...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object
     * The constructor takes in two Strings as arguments
     * @param first_string the first half of the instance name
     * @param second_string the second half of the instance name
     */
